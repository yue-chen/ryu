...
#
# http://docs.python.org/faq/programming.html#how-do-i-get-a-list-of-all-instan`ces-of-a-given-class
# How do I get a list of all instances of a given class?
# Python does not keep track of all instances of a class (or of a
# built-in type). You can program the class¡Çs constructor to keep
